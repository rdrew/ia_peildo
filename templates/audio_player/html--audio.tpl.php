...
<script type="text/javascript" src="/<?php print drupal_get_path('theme', 'ia_peildo'); ?>/js/components/audio_player/amplitudejs/dist/amplitude.js"></script>
</head>
...
<script type="text/javascript" src="/<?php print drupal_get_path('theme', 'ia_peildo'); ?>/js/components/audio_player/functions.js"></script>
</body>
</html>
