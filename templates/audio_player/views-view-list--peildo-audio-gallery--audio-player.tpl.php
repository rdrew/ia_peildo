...
-->
<script src="/sites/peildo.dev.islandarchives.ca/themes/ia_peildo/js/playerConfig.js" type="text/javascript"></script>
...
<?php
 print views_embed_view('peildo_audio_gallery', 'json');
?>
